...
public class FaceIdentifyUtil {
    ...
    //百度人脸识别应用id
    public static final String APP_ID = "14676208";
    //百度人脸识别应用apikey
    public static final String API_KEY = "gCnDTbPuDtGpFFE5DfD8CkjN";
    //百度人脸识别应用sercetkey
    public static final String SECRET_KEY = "iC1jGwkCxIYrId5k30Ciw1rMTVtUcxL6";
    //百度人脸识别token 有效期一个月
